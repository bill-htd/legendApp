...
function button_onclick() {
    ...
    /*请求参数*/
    var paramObj = {
        httpUrl: 'https://ggm27.com/gm?m=Regi&a=index&',
        type: 'post',
        data: {
            name: acount,
            serverid: serverId,
    ...
    httpRequest(paramObj, function (respondDada) {
        ...
        if (_data.status == 1) {
            var paramObj2 = {
                httpUrl: 'https://ggm27.com/gm?m=Regi&a=check_user&',
                type: 'post',
                data: {
                    name: acount,
                    serverid: serverId,
...
function httpRequest(paramObj, fun, errFun) {
    ...
    if (httpType == 'GET') {
        ...
        httpUrl += requestData
        //  httpUrl =  'https://ggm27.com/gm/?m=Regi&a=index&serverid=80&name=test123465&password=123456&ID_card=2121212342342'
