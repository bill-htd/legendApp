...
var paramObj = {
    httpUrl: 'http://ezz25.com/gm/index.php?m=ServerInfo&a=server_list',
    type: 'post',
}
var self = this
...
function button_onclick() {
    ...
    /*请求参数*/
    var paramObj = {
        httpUrl: 'https://ezz25.com/gm?m=Regi&a=index&',
        type: 'post',
        data: {
            name: acount,
            serverid: serverId,
    ...
    httpRequest(paramObj, function (respondDada) {
        ...
        if (_data.status == 1) {
            var paramObj2 = {
                httpUrl: 'https://ezz25.com/gm?m=Regi&a=check_user&',
                type: 'post',
                data: {
                    name: acount,
                    serverid: serverId,
...
function httpRequest(paramObj, fun, errFun) {
    ...
    if (httpType == 'GET') {
        ...
        httpUrl += requestData
        //  httpUrl =  'https://ezz25.com/gm/?m=Regi&a=index&serverid=80&name=test123465&password=123456&ID_card=2121212342342'
