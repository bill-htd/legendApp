...
class OSATarget2Panel3 extends BaseView{
	...
	private _config:ActivityType2Config[]|PActivity2Config[];

	private _activityData: ActivityType2Data|PActivityType2Data;
	...
	private updateData(){
		if( this.activityType == ActivityType.Normal ){
			...
			this._activityData = PActivity.ins().getActivityDataById(this.activityID) as PActivityType2Data;
	...
	private updatePage():void
	{
		...
		let config:ActivityType2Config|PActivity2Config = this._config[this._curPage];
