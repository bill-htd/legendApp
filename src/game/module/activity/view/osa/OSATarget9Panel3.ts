class OSATarget9Panel3 extends BaseView {
	...
	private updateProgress() {
		...
		if (this.actType == ActivityType.Normal) {
			ins = Activity.ins();
			data = ins.activityData[this.activityID] as ActivityType9Data;
		} else if (this.actType == ActivityType.Personal) {
			ins = PActivity.ins();
			data = ins.activityData[this.activityID] as PActivityType9Data;
		}
		let config: ActivityType9Config | PActivity9Config = this.config9[this.activityID][0];
