...
class DailyCheckIn extends BaseSystem {
	...
	public constructor() {
		...
		this.regNetMsg(3, this.handleCheckInData);
	...
	public postCheckInData(bytes: GameByteArray): void {
		...
		// console.log('签到数据没操作！！！ ： ')
		// console.log(this._loginTimes , this.todayReward , this.conLoginTimes,this.rewardIndex)
		
		// MonthSignDaysConfig.days = this._loginTimes
		// this.rewardList = {};
	 ...
	 * @returns void
	 */
	public handleCheckInData(bytes: GameByteArray): void {
		// this._loginTimes = bytes.readShort();
		// this.todayReward = bytes.readBoolean()
		// this.conLoginTimes = bytes.readShort();
		// this.rewardIndex = bytes.readShort();
