...
class WJBattlefieldDataWin extends BaseEuiView {
	...
	private _myScore: egret.DisplayObjectContainer;
	private _enemyScore: egret.DisplayObjectContainer;
	...
	public close(...args): void {
		WatcherUtil.removeFromArrayCollection(this.myList.dataProvider as eui.ArrayCollection);
		this.myList.dataProvider = null;

		WatcherUtil.removeFromArrayCollection(this.enemyList.dataProvider as eui.ArrayCollection);
