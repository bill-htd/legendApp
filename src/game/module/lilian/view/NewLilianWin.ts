class NewLilianWin extends BaseEuiView {
	...
	private showAct: eui.Group;//爵位界面信息界面
	private Activation: eui.Group;//开启激活爵位界面

	private UplevelBtn0: eui.Button;//开启爵位按钮
	...
	// private gift0 //图标
	private trainMc:Map<MovieClip>;//爵位每日奖励特效
	public constructor() {
		super();
		this.name = `爵位`;
	...
	private setWinData(): void {
		...
		let imgType = config.type > 14 ? 14 : config.type;
