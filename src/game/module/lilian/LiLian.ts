...
class LiLian extends BaseSystem {
	...
	// public nobilityIsOpen: boolean = false;	   //勋章是否开启
	public nobilityIsUpGrade: number = 0;	//爵位是否可以升级 0-不可以  1-可以
	public nobilityLv: number = 0;			//勋章等级
	public xunzhangJF: number = 0;    //勋章当前成就积分
	...
	//============================================================================================
	/**
	 * 爵位 NewLilianWin->startActivation
	 */
	public isShow: boolean = false;//是否显示爵位特效界面
	...
	/**
	 * 勋章 XunzhangPanel->update
	 * */
	// public xunzhangAct = -1;
	public isXZShow: boolean = false;//是否显示勋章特效界面
