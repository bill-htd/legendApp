...
class ZhanLing extends BaseSystem {
	...
	private doZhanLingSkill(bytes: GameByteArray): void {
		...
		let talentLv: number = GlobalConfig.ZhanLingLevel[id][zlData.level].talentLevel;
		let dp = GlobalConfig.ZhanLingTalent[id][talentLv];
