class NeiGongWin extends BaseView {
	...
	// private stageImg: egret.DisplayObjectContainer;
	...
	private data: any;
	private mcPos: number[][] = [[52, 127, 0], [47, 105, 18], [55, 80, 36], [75, 62, 54], [110, 50, 72],
	...
	private setAttrCost(): void {
		...
		// BitmapNumber.ins().changeNum(this.stageImg, this.data.stage, "ng0");
