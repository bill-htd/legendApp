class BattleWin extends BaseEuiView {
	...
	public skillGroup0: eui.Group;
	public lzlabel0: eui.BitmapLabel;
	public lztitle0: eui.BitmapLabel;
	...
	private onKill(value: number): void {
		...
		let self = this;
		egret.Tween.get(this.lzlabel0).to({scaleX: 2, scaleY: 2}, 200).to({scaleX: 1, scaleY: 1}, 100).call(() => {
			egret.Tween.get(self.skillGroup0).wait(1000).to({alpha: 0}, 1000).call(() => {
