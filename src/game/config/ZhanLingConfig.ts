class ZhanLingConfig {
	...
	public showzhanlinglv:number;//战灵外显等级
	public showzhanlingcd:number;//战灵外显cd(毫秒)
	public stageitemid:number;//战灵/幻形进阶丹id
	...
	public hintNum:number;//战灵一键升星红点提示
	public anchorOffset:number[];
	public delayTime:number;//延迟显示的时间（毫秒）
	public fbIndex:number;//战灵副本ID
}