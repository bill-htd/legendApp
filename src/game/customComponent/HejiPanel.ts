class HejiPanel extends BaseView {
	...
	private bagua1: eui.Image;
	private bagua2: eui.Image;
	private bagua3: eui.Image;
	private bagua4: eui.Image;
	private bagua5: eui.Image;
	private bagua6: eui.Image;
	private bagua7: eui.Image;
	private bagua8: eui.Image;
	private bagua: eui.Image[];
	...
	private colorGrayN: number = 0x444134;
	...
	private unActTextArr: string[] = ["装备3件符文大幅增强对玩家的伤害", "装备5件符文大幅增强对怪物的伤害", "装备8件符文大幅减少合击冷却时间"];
	...
	private setPunchView(): void {
		...
		for(let j = 0;j<this.bagua.length;j++){
