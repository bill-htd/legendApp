...
var KeyCode = (function () {
    ...
    KeyCode.KC_NUMPAD_ENTER = 108;
    KeyCode.KC_NUMPAD_SUBTRACT = 109;
    KeyCode.KC_NUMPAD_DECIMAL = 110;
    KeyCode.KC_NUMPAD_DIVIDE = 111;
    KeyCode.KC_BACKSPACE = 8;
    KeyCode.KC_TAB = 9;
    KeyCode.KC_ENTER = 13;
    KeyCode.KC_SHIFT = 16;
    KeyCode.KC_CONTROL = 17;
    KeyCode.KC_ESCAPE = 27;
    KeyCode.KC_SPACE = 32;
    KeyCode.KC_WINDOWS = 91;
    KeyCode.KC_MENU = 93;
    KeyCode.KC_CAPS_LOCK = 20;
    KeyCode.KC_NUM_LOCK = 144;
    KeyCode.KC_SCROLL_LOCK = 145;
    KeyCode.KC_PAUSE = 19;
    KeyCode.KC_PAGE_UP = 33;
    KeyCode.KC_PAGE_DOWN = 34;
    KeyCode.KC_END = 35;
    KeyCode.KC_HOME = 36;
    KeyCode.KC_INSERT = 45;
    KeyCode.KC_DELETE = 46;
    KeyCode.KC_LEFT = 37;
    KeyCode.KC_UP = 38;
    KeyCode.KC_RIGHT = 39;
    KeyCode.KC_DOWN = 40;
    ...
    KeyCode.KC_MINUS_UNDERLINE = 189;
