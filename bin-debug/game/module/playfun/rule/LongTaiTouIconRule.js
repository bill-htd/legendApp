...
var LongTaiTouIconRule = (function (_super) {
    __extends(LongTaiTouIconRule, _super);
    function LongTaiTouIconRule(id, t) {
    ...
    LongTaiTouIconRule.prototype.checkShowIcon = function () {
    ...
    LongTaiTouIconRule.prototype.checkShowRedPoint = function () {
        var data = Activity.ins().activityData;
        for (var k in data) {
            var actData = data[k];
            if (actData.pageStyle == ActivityPageStyle.LONGTAITOU) {
    ...
    LongTaiTouIconRule.prototype.getEffName = function (redPointNum) {
    ...
    LongTaiTouIconRule.prototype.tapExecute = function () {
    ...
    return LongTaiTouIconRule;
}(RuleIconBase));
__reflect(LongTaiTouIconRule.prototype, "LongTaiTouIconRule");
//# sourceMappingURL=LongTaiTouIconRule.js.map