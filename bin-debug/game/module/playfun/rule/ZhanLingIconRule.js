...
var ZhanLingIconRule = (function (_super) {
    __extends(ZhanLingIconRule, _super);
    function ZhanLingIconRule(id, t) {
    ...
    ZhanLingIconRule.prototype.checkShowIcon = function () {
    ...
    ZhanLingIconRule.prototype.checkShowRedPoint = function () {
        var data = Activity.ins().activityData;
        for (var k in data) {
            var actData = data[k];
            if (actData.pageStyle == ActivityPageStyle.ZHANLING) {
    ...
    ZhanLingIconRule.prototype.getEffName = function (redPointNum) {
    ...
    ZhanLingIconRule.prototype.tapExecute = function () {
    ...
    return ZhanLingIconRule;
}(RuleIconBase));
__reflect(ZhanLingIconRule.prototype, "ZhanLingIconRule");
//# sourceMappingURL=ZhanLingIconRule.js.map