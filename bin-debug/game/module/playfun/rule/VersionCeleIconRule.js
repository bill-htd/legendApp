...
var VersionCeleIconRule = (function (_super) {
    __extends(VersionCeleIconRule, _super);
    function VersionCeleIconRule(id, t) {
    ...
    VersionCeleIconRule.prototype.checkShowIcon = function () {
    ...
    VersionCeleIconRule.prototype.checkShowRedPoint = function () {
        var data = Activity.ins().activityData;
        for (var k in data) {
            var actData = data[k];
            if (actData.pageStyle == ActivityPageStyle.VERSIONCELE) {
    ...
    VersionCeleIconRule.prototype.getEffName = function (redPointNum) {
    ...
    VersionCeleIconRule.prototype.tapExecute = function () {
    ...
    return VersionCeleIconRule;
}(RuleIconBase));
__reflect(VersionCeleIconRule.prototype, "VersionCeleIconRule");
//# sourceMappingURL=VersionCeleIconRule.js.map