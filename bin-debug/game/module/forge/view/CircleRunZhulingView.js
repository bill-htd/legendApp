...
var CircleRunZhulingView = (function (_super) {
    __extends(CircleRunZhulingView, _super);
    function CircleRunZhulingView() {
        var _this = _super.call(this) || this;
        _this.skinName = "CircleRunZhulingSkin";
        _this.itemList = [];
    ...
    Object.defineProperty(CircleRunZhulingView.prototype, "type", {
        get: function () {
            return this._type;
        },
        set: function (value) {
    ...
    CircleRunZhulingView.prototype.setValue = function () {
    ...
    CircleRunZhulingView.prototype.turnItem = function (pos) {
        this.setItemSelect(pos);
    };
    CircleRunZhulingView.prototype.setItemSelect = function (pos) {
    ...
    return CircleRunZhulingView;
}(BaseView));
__reflect(CircleRunZhulingView.prototype, "CircleRunZhulingView");
//# sourceMappingURL=CircleRunZhulingView.js.map