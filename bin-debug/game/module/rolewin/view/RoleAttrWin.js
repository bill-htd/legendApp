...
var RoleAttrWin = (function (_super) {
    ...
    RoleAttrWin.prototype.open = function () {
        var param = [];
    ...
    RoleAttrWin.prototype.close = function () {
        var param = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            param[_i] = arguments[_i];
        }
    ...
    RoleAttrWin.prototype.onClose = function (e) {
        ViewManager.ins().close(this);
    };
    RoleAttrWin.prototype.otherClose = function (e) {
        if (e.target == this.bg || e.target instanceof eui.Button)
            return;
        ViewManager.ins().close(this);
    };
    RoleAttrWin.prototype.onMove = function (e) {
        switch (e.type) {
    ...
    RoleAttrWin.prototype.moveAttr = function (num) {
    ...
    RoleAttrWin.prototype.onTouch = function (e) {
    ...
    RoleAttrWin.prototype.setRoleAttr = function (roleId) {
    ...
    RoleAttrWin.prototype.setBtn = function () {
        var len = SubRoles.ins().subRolesLen;
        if (len == 1) {
