...
var ZhanLingACTWin = (function (_super) {
    __extends(ZhanLingACTWin, _super);
    function ZhanLingACTWin() {
        var _this = _super.call(this) || this;
        _this.activityPanelList = [];
        _this.selectIndex = 0;
        _this.skinName = "ZhanlingActWin";
        _this.isTopLevel = true;
        return _this;
    }
    ZhanLingACTWin.prototype.initUI = function () {
        _super.prototype.initUI.call(this);
        this.menuList.itemRenderer = ActivityBtnRenderer;
    };
    ZhanLingACTWin.prototype.open = function () {
        var param = [];
    ...
    ZhanLingACTWin.prototype.close = function () {
    ...
    ZhanLingACTWin.prototype.onChange = function () {
    ...
    ZhanLingACTWin.prototype.updateView = function () {
        var i = 0;
    ...
    ZhanLingACTWin.prototype.refushRedPoint = function () {
        this.dataArr.replaceAll(this._datas);
        this.menuList.dataProvider = this.dataArr;
    };
    ZhanLingACTWin.prototype.sort = function (a, b) {
        if (a.sort > b.sort)
            return 1;
    ...
    ZhanLingACTWin.prototype.onTouch = function (e) {
        var num = 92 * 5;
        var scrollH = 0;
        switch (e.target) {
            case this.closeBtn:
    ...
    ZhanLingACTWin.prototype.onClickMenu = function (e) {
    ...
    return ZhanLingACTWin;
}(BaseEuiView));
__reflect(ZhanLingACTWin.prototype, "ZhanLingACTWin");
ViewManager.ins().reg(ZhanLingACTWin, LayerManager.UI_Main);
//# sourceMappingURL=ZhanLingACTWin.js.map