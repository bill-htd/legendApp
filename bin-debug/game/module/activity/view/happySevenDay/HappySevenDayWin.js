...
var HappySevenDayWin = (function (_super) {
    __extends(HappySevenDayWin, _super);
    function HappySevenDayWin() {
    ...
    HappySevenDayWin.prototype.setActivityID = function () {
    ...
    HappySevenDayWin.prototype.setCurSkin = function () {
    ...
    HappySevenDayWin.prototype.initUI = function () {
    ...
    HappySevenDayWin.prototype.open = function () {
        var param = [];
    ...
    HappySevenDayWin.prototype.close = function () {
        this._tabCollect = null;
        this._btnCollect = null;
        this._listCollect = null;
    };
    HappySevenDayWin.prototype.updateView = function () {
    ...
    HappySevenDayWin.prototype.refreshReds = function () {
        this.updateView();
        this.updateTabs();
        this.updateData();
        this.updateTargetAward();
    };
    HappySevenDayWin.prototype.updateData = function () {
    ...
    HappySevenDayWin.prototype.sort = function (a, b) {
    ...
    HappySevenDayWin.prototype.updateTargetAward = function () {
    ...
    HappySevenDayWin.prototype.onTouch = function (e) {
        switch (e.target) {
            case this.closeBtn:
    ...
    HappySevenDayWin.prototype.onClickBtn = function (e) {
    ...
    HappySevenDayWin.prototype.onTabBtn = function (e) {
    ...
    HappySevenDayWin.prototype.updateTabs = function () {
    ...
    HappySevenDayWin.prototype.setTime = function () {
        var data = Activity.ins().activityData[this._activityID];
        if (data)
            this.actTime0.text = data.getRemainTime();
    };
    return HappySevenDayWin;
}(BaseEuiView));
__reflect(HappySevenDayWin.prototype, "HappySevenDayWin");
ViewManager.ins().reg(HappySevenDayWin, LayerManager.UI_Main);
//# sourceMappingURL=HappySevenDayWin.js.map