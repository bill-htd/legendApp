...
var LongTaiTouWin = (function (_super) {
    __extends(LongTaiTouWin, _super);
    function LongTaiTouWin() {
        var _this = _super.call(this) || this;
        _this.activityPanelList = [];
        _this.skinName = "longtaitouWin";
        _this.isTopLevel = true;
        _this.selectIndex = 0;
        return _this;
    }
    LongTaiTouWin.prototype.initUI = function () {
        _super.prototype.initUI.call(this);
        this._pageStyle = ActivityPageStyle.LONGTAITOU;
        this.menuList.itemRenderer = ActivityBtnRenderer;
    };
    LongTaiTouWin.prototype.checkIndexByActivityId = function (actId) {
    ...
    LongTaiTouWin.openCheck = function () {
        var param = [];
    ...
    LongTaiTouWin.prototype.open = function () {
        var param = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            param[_i] = arguments[_i];
        }
    ...
    LongTaiTouWin.prototype.close = function () {
        var param = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            param[_i] = arguments[_i];
        }
    ...
    LongTaiTouWin.prototype.refushRedPoint = function () {
        this.dataArr.replaceAll(this.BtnArr);
        this.menuList.dataProvider = this.dataArr;
    };
    LongTaiTouWin.prototype.updateView = function () {
        var index = 0;
        var i = 0;
    ...
    LongTaiTouWin.prototype.updatePanel = function (activityID) {
    ...
    LongTaiTouWin.prototype.onClick = function (e) {
    ...
    LongTaiTouWin.prototype.setOpenIndex = function (selectedIndex) {
    ...
    LongTaiTouWin.prototype.onClickMenu = function (e) {
        this.actId = 0;
    ...
    LongTaiTouWin.prototype.ChangePageCallBack = function () {
        if (this.actId)
            this.selectIndex = this.checkIndexByActivityId(this.actId);
        this.setOpenIndex(this.selectIndex);
    };
    LongTaiTouWin.prototype.onChange = function () {
    ...
    LongTaiTouWin.prototype.onTouchBtn = function (e) {
        var num = 92 * 5;
        var scrollH = 0;
        switch (e.target) {
            case this.leftBtn:
    ...
    LongTaiTouWin.prototype.sort = function (a, b) {
        if (a.sort > b.sort)
            return 1;
    ...
    return LongTaiTouWin;
}(BaseEuiView));
__reflect(LongTaiTouWin.prototype, "LongTaiTouWin");
ViewManager.ins().reg(LongTaiTouWin, LayerManager.UI_Main);
//# sourceMappingURL=LongTaiTouWin.js.map