...
var VersionCeleWin = (function (_super) {
    __extends(VersionCeleWin, _super);
    function VersionCeleWin() {
        var _this = _super.call(this) || this;
        _this.activityPanelList = [];
        _this.selectIndex = 0;
        _this.skinName = "carnivalWin";
        _this.isTopLevel = true;
        return _this;
    }
    VersionCeleWin.prototype.initUI = function () {
        _super.prototype.initUI.call(this);
        this.menuList.itemRenderer = ActivityBtnRenderer;
    };
    VersionCeleWin.prototype.open = function () {
        var param = [];
    ...
    VersionCeleWin.prototype.close = function () {
    ...
    VersionCeleWin.prototype.onChange = function () {
    ...
    VersionCeleWin.prototype.updateView = function () {
        var i = 0;
    ...
    VersionCeleWin.prototype.refushRedPoint = function () {
        this.dataArr.replaceAll(this._datas);
        this.menuList.dataProvider = this.dataArr;
    };
    VersionCeleWin.prototype.sort = function (a, b) {
        if (a.sort > b.sort)
            return 1;
    ...
    VersionCeleWin.prototype.onTouch = function (e) {
        var num = 92 * 5;
        var scrollH = 0;
        switch (e.target) {
            case this.closeBtn:
    ...
    VersionCeleWin.prototype.onClickMenu = function (e) {
    ...
    return VersionCeleWin;
}(BaseEuiView));
__reflect(VersionCeleWin.prototype, "VersionCeleWin");
ViewManager.ins().reg(VersionCeleWin, LayerManager.UI_Main);
//# sourceMappingURL=VersionCeleWin.js.map