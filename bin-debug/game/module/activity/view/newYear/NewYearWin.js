...
var NewYearWin = (function (_super) {
    __extends(NewYearWin, _super);
    function NewYearWin() {
        var _this = _super.call(this) || this;
        _this.activityPanelList = [];
        _this.selectIndex = 0;
        _this.skinName = "newYearWin";
        _this.isTopLevel = true;
        return _this;
    }
    NewYearWin.prototype.initUI = function () {
        _super.prototype.initUI.call(this);
        this.menuList.itemRenderer = ActivityBtnRenderer;
    };
    NewYearWin.prototype.open = function () {
        var param = [];
    ...
    NewYearWin.prototype.close = function () {
    ...
    NewYearWin.prototype.onChange = function () {
    ...
    NewYearWin.prototype.updateView = function () {
        var i = 0;
        ...
        for (var k in Activity.ins().activityData) {
            if (!Activity.ins().activityData[k])
                continue;
            if (Activity.ins().activityData[k].pageStyle == ActivityPageStyle.NEWYEAR && Activity.ins().getActivityDataById(+k).isOpenActivity() && !Activity.ins().getActivityDataById(+k).getHide())
    ...
    NewYearWin.prototype.refushRedPoint = function () {
        this.dataArr.replaceAll(this._datas);
        this.menuList.dataProvider = this.dataArr;
    };
    NewYearWin.prototype.sort = function (a, b) {
        if (a.sort > b.sort)
            return 1;
    ...
    NewYearWin.prototype.onTouch = function (e) {
        var num = 92 * 5;
        var scrollH = 0;
        switch (e.target) {
            case this.closeBtn:
    ...
    NewYearWin.prototype.onClickMenu = function (e) {
...
__reflect(NewYearWin.prototype, "NewYearWin");
ViewManager.ins().reg(NewYearWin, LayerManager.UI_Main);
//# sourceMappingURL=NewYearWin.js.map