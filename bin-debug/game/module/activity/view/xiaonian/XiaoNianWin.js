...
var XiaoNianWin = (function (_super) {
    __extends(XiaoNianWin, _super);
    function XiaoNianWin() {
        var _this = _super.call(this) || this;
        _this.activityPanelList = [];
        _this.skinName = "XiaoNianWinSkin";
        _this.isTopLevel = true;
        _this.selectIndex = 0;
        return _this;
    }
    XiaoNianWin.prototype.initUI = function () {
        _super.prototype.initUI.call(this);
        this._pageStyle = ActivityPageStyle.XIAONIAN;
        this.menuList.itemRenderer = ActivityBtnRenderer;
    };
    XiaoNianWin.prototype.checkIndexByActivityId = function (actId) {
    ...
    XiaoNianWin.openCheck = function () {
        var param = [];
    ...
    XiaoNianWin.prototype.open = function () {
        var param = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            param[_i] = arguments[_i];
        }
    ...
    XiaoNianWin.prototype.close = function () {
        var param = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            param[_i] = arguments[_i];
        }
    ...
    XiaoNianWin.prototype.refushRedPoint = function () {
        this.dataArr.replaceAll(this.BtnArr);
        this.menuList.dataProvider = this.dataArr;
    };
    XiaoNianWin.prototype.updateView = function () {
        var index = 0;
        var i = 0;
    ...
    XiaoNianWin.prototype.updatePanel = function (activityID) {
    ...
    XiaoNianWin.prototype.onClick = function (e) {
    ...
    XiaoNianWin.prototype.setOpenIndex = function (selectedIndex) {
    ...
    XiaoNianWin.prototype.onClickMenu = function (e) {
        this.actId = 0;
    ...
    XiaoNianWin.prototype.ChangePageCallBack = function () {
        if (this.actId)
            this.selectIndex = this.checkIndexByActivityId(this.actId);
        this.setOpenIndex(this.selectIndex);
    };
    XiaoNianWin.prototype.onChange = function () {
    ...
    XiaoNianWin.prototype.onTouchBtn = function (e) {
        var num = 92 * 5;
        var scrollH = 0;
        switch (e.target) {
            case this.leftBtn:
    ...
    XiaoNianWin.prototype.sort = function (a, b) {
        if (a.sort > b.sort)
            return 1;
...
__reflect(XiaoNianWin.prototype, "XiaoNianWin");
ViewManager.ins().reg(XiaoNianWin, LayerManager.UI_Main);
//# sourceMappingURL=XiaoNianWin.js.map