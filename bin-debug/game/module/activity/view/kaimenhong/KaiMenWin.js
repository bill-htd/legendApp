...
var KaiMenWin = (function (_super) {
    __extends(KaiMenWin, _super);
    function KaiMenWin() {
        var _this = _super.call(this) || this;
        _this.activityPanelList = [];
        _this.skinName = "kaimenhongWin";
        _this.isTopLevel = true;
        _this.selectIndex = 0;
        return _this;
    }
    KaiMenWin.prototype.initUI = function () {
        _super.prototype.initUI.call(this);
        this._pageStyle = ActivityPageStyle.KAIMENHONG;
        this.menuList.itemRenderer = ActivityBtnRenderer;
    };
    KaiMenWin.prototype.checkIndexByActivityId = function (actId) {
    ...
    KaiMenWin.prototype.open = function () {
        var param = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            param[_i] = arguments[_i];
        }
    ...
    KaiMenWin.prototype.close = function () {
        var param = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            param[_i] = arguments[_i];
        }
    ...
    KaiMenWin.prototype.refushRedPoint = function () {
        this.dataArr.replaceAll(this.BtnArr);
        this.menuList.dataProvider = this.dataArr;
    };
    KaiMenWin.prototype.updateView = function () {
        var index = 0;
        var i = 0;
    ...
    KaiMenWin.prototype.updatePanel = function (activityID) {
    ...
    KaiMenWin.prototype.onClick = function (e) {
    ...
    KaiMenWin.prototype.setOpenIndex = function (selectedIndex) {
    ...
    KaiMenWin.prototype.onClickMenu = function (e) {
        this.actId = 0;
    ...
    KaiMenWin.prototype.ChangePageCallBack = function () {
        if (this.actId)
            this.selectIndex = this.checkIndexByActivityId(this.actId);
        this.setOpenIndex(this.selectIndex);
    };
    KaiMenWin.prototype.onChange = function () {
    ...
    KaiMenWin.prototype.onTouchBtn = function (e) {
        var num = 92 * 5;
        var scrollH = 0;
        switch (e.target) {
            case this.leftBtn:
    ...
    KaiMenWin.prototype.sort = function (a, b) {
        if (a.sort > b.sort)
            return 1;
...
__reflect(KaiMenWin.prototype, "KaiMenWin");
ViewManager.ins().reg(KaiMenWin, LayerManager.UI_Main);
//# sourceMappingURL=KaiMenWin.js.map