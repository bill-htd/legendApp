...
var LabaWin = (function (_super) {
    __extends(LabaWin, _super);
    function LabaWin() {
        var _this = _super.call(this) || this;
        _this.activityPanelList = [];
        _this.skinName = "LaBaWin";
        _this.isTopLevel = true;
        _this.selectIndex = 0;
        return _this;
    }
    LabaWin.prototype.initUI = function () {
        _super.prototype.initUI.call(this);
        this._pageStyle = ActivityPageStyle.LABA;
        this.menuList.itemRenderer = ActivityBtnRenderer;
    };
    LabaWin.prototype.checkIndexByActivityId = function (actId) {
    ...
    LabaWin.prototype.open = function () {
        var param = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            param[_i] = arguments[_i];
        }
    ...
    LabaWin.prototype.close = function () {
        var param = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            param[_i] = arguments[_i];
        }
    ...
    LabaWin.prototype.refushRedPoint = function () {
        this.dataArr.replaceAll(this.BtnArr);
        this.menuList.dataProvider = this.dataArr;
    };
    LabaWin.prototype.updateView = function () {
        var index = 0;
        var i = 0;
    ...
    LabaWin.prototype.updatePanel = function (activityID) {
    ...
    LabaWin.prototype.onClick = function (e) {
    ...
    LabaWin.prototype.setOpenIndex = function (selectedIndex) {
    ...
    LabaWin.prototype.onClickMenu = function (e) {
        this.actId = 0;
    ...
    LabaWin.prototype.ChangePageCallBack = function () {
        if (this.actId)
            this.selectIndex = this.checkIndexByActivityId(this.actId);
        this.setOpenIndex(this.selectIndex);
    };
    LabaWin.prototype.onChange = function () {
    ...
    LabaWin.prototype.onTouchBtn = function (e) {
        var num = 92 * 5;
        var scrollH = 0;
        switch (e.target) {
            case this.leftBtn:
    ...
    LabaWin.prototype.sort = function (a, b) {
        if (a.sort > b.sort)
            return 1;
...
__reflect(LabaWin.prototype, "LabaWin");
ViewManager.ins().reg(LabaWin, LayerManager.UI_Main);
//# sourceMappingURL=LabaWin.js.map