...
var OSATarget3Panel2 = (function (_super) {
    __extends(OSATarget3Panel2, _super);
    function OSATarget3Panel2() {
        var _this = _super.call(this) || this;
        _this._state = 0;
        _this._index = 1;
        _this._time = 0;
        _this.skinName = "OSATotalRechargeSkin";
        return _this;
    }
    OSATarget3Panel2.prototype.childrenCreated = function () {
        _super.prototype.childrenCreated.call(this);
        this.reward.itemRenderer = ItemBase;
    };
    OSATarget3Panel2.prototype.open = function () {
        this.addTouchEvent(this.getBtn, this.onTap);
        TimerManager.ins().doTimer(1000, 0, this.setTime, this);
        this.actType = ActivityPanel.getActivityTypeFromId(this.activityID);
        this.initData();
    };
    OSATarget3Panel2.prototype.initData = function () {
        if (!this.rechargeBar) {
    ...
    OSATarget3Panel2.prototype.updateTime = function () {
        var act;
        var config;
        if (this.actType == ActivityType.Normal) {
            act = Activity.ins().getActivityDataById(this.activityID);
    ...
    OSATarget3Panel2.prototype.setTime = function () {
        if (this._time > 0) {
            this._time -= 1;
            this.actTime.text = DateUtils.getFormatBySecond(this._time, DateUtils.TIME_FORMAT_5, 3);
        }
    };
    OSATarget3Panel2.prototype.onTap = function () {
        if (this._state == 1) {
    ...
    OSATarget3Panel2.prototype.close = function () {
        this.removeTouchEvent(this.getBtn, this.onTap);
        TimerManager.ins().removeAll(this);
    };
    OSATarget3Panel2.prototype.updateData = function () {
        this.initData();
    };
    return OSATarget3Panel2;
}(BaseView));
__reflect(OSATarget3Panel2.prototype, "OSATarget3Panel2");
//# sourceMappingURL=OSATarget3Panel2.js.map