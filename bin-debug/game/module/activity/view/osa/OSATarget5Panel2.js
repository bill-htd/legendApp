...
var OSATarget5Panel2 = (function (_super) {
    __extends(OSATarget5Panel2, _super);
    function OSATarget5Panel2() {
        var _this = _super.call(this) || this;
        _this.itemary = [];
        _this.dayindex = 1;
        _this.itemList = [];
        _this.skinName = "ganenLogSkin";
        _this.itemary = [];
        return _this;
    }
    OSATarget5Panel2.prototype.open = function () {
        var param = [];
    ...
    OSATarget5Panel2.prototype.setTime = function () {
    ...
    OSATarget5Panel2.prototype.close = function () {
        var param = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            param[_i] = arguments[_i];
        }
    ...
    OSATarget5Panel2.prototype.changeList = function () {
        var day = 1;
    ...
    OSATarget5Panel2.prototype.onTouch = function (e) {
    ...
    OSATarget5Panel2.prototype.itemTouch = function (e) {
        this.setList(e.currentTarget.data);
    };
    OSATarget5Panel2.prototype.setList = function (index) {
    ...
    OSATarget5Panel2.prototype.showRedPoint = function () {
    };
    OSATarget5Panel2.prototype.updateData = function () {
        this.changeList();
        this.showRedPoint();
        this.setTime();
    };
    return OSATarget5Panel2;
}(BaseView));
__reflect(OSATarget5Panel2.prototype, "OSATarget5Panel2");
//# sourceMappingURL=OSATarget5Panel2.js.map