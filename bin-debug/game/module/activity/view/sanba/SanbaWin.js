...
var SanbaWin = (function (_super) {
    __extends(SanbaWin, _super);
    function SanbaWin() {
        var _this = _super.call(this) || this;
        _this.activityPanelList = [];
        _this.selectIndex = 0;
        _this.skinName = "sanbaWin";
        _this.isTopLevel = true;
        return _this;
    }
    SanbaWin.prototype.initUI = function () {
        _super.prototype.initUI.call(this);
        this.menuList.itemRenderer = ActivityBtnRenderer;
    };
    SanbaWin.prototype.open = function () {
        var param = [];
    ...
    SanbaWin.prototype.updateView = function () {
        var i = 0;
    ...
    SanbaWin.prototype.refushRedPoint = function () {
        this.dataArr.replaceAll(this._datas);
        this.menuList.dataProvider = this.dataArr;
    };
    SanbaWin.prototype.sort = function (a, b) {
        if (a.sort > b.sort)
            return 1;
    ...
    SanbaWin.prototype.onTouch = function (e) {
        var num = 92 * 5;
        var scrollH = 0;
        switch (e.target) {
            case this.closeBtn:
    ...
    SanbaWin.prototype.onClickMenu = function (e) {
...
__reflect(SanbaWin.prototype, "SanbaWin");
ViewManager.ins().reg(SanbaWin, LayerManager.UI_Main);
//# sourceMappingURL=SanbaWin.js.map