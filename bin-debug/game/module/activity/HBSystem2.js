...
var HBSystem2 = (function (_super) {
    __extends(HBSystem2, _super);
    function HBSystem2() {
        return _super.call(this) || this;
    }
    HBSystem2.ins = function () {
        return _super.ins.call(this);
    };
    HBSystem2.prototype.handleHongbao = function () {
    ...
    HBSystem2.prototype.updateHongBao = function () {
        TimerManager.ins().doTimer(1000, 1, this.handleHongbao, this);
    };
    HBSystem2.prototype.updateHBTime = function () {
        var view = ViewManager.ins().getView(PlayFunView);
        if (Activity.ins().activityData[2001] instanceof ActivityType24Data) {
            var actData = Activity.ins().activityData[2001];
            for (var j = actData.envelopeData.length - 1; j >= 0;) {
    ...
    HBSystem2.prototype.showHongBaoTips = function (param) {
        var actId = param[0];
        var eId = param[1];
        var yb = param[2];
        var gold = param[3];
    ...
    HBSystem2.prototype.HongBaoResultAni = function (arr) {
        var view = ViewManager.ins().getView(PlayFunView);
        if (!view || !view.hongbao)
            return;
    ...
    HBSystem2.prototype.ActRewardResult = function (activityID) {
    ...
    HBSystem2.prototype.showEnvelope = function (eld) {
        var view = ViewManager.ins().getView(PlayFunView);
        if (!view || !view.hongbao)
            return;
        if (!eld) {
    ...
    HBSystem2.prototype.testhongbao = function () {
        var view = ViewManager.ins().getView(PlayFunView);
        view.hongbao.removeChildren();
        ViewManager.ins().open(FuliWin, 6);
    };
    HBSystem2.prototype.removeHongbao = function () {
        var view = ViewManager.ins().getView(PlayFunView);
        view.hongbao.removeChildren();
    };
    HBSystem2.prototype.closeallhongbao = function () {
    };
    return HBSystem2;
}(BaseSystem));
__reflect(HBSystem2.prototype, "HBSystem2");
//# sourceMappingURL=HBSystem2.js.map