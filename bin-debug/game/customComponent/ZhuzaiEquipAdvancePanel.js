...
var ZhuzaiEquipAdvancePanel = (function (_super) {
    __extends(ZhuzaiEquipAdvancePanel, _super);
    function ZhuzaiEquipAdvancePanel() {
        return _super.call(this) || this;
    }
    ZhuzaiEquipAdvancePanel.prototype.childrenCreated = function () {
    };
    ZhuzaiEquipAdvancePanel.prototype.initUI = function () {
        this.tab = [];
        for (var i = 0; i < 4; i++)
    ...
    ZhuzaiEquipAdvancePanel.prototype.open = function () {
        var param = [];
    ...
    ZhuzaiEquipAdvancePanel.prototype.close = function () {
        var param = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            param[_i] = arguments[_i];
        }
    ...
    ZhuzaiEquipAdvancePanel.prototype.update = function () {
        this.setEquipPoint();
        this.setData();
    };
    ZhuzaiEquipAdvancePanel.prototype.onChange = function (e) {
        this.parent.parent.selectRole = this.roleSelectPanel.getCurRole();
        this.update();
    };
    ZhuzaiEquipAdvancePanel.prototype.setData = function () {
        ...
        var nextConfig = GlobalConfig.EquipPointGrowUpConfig[index][lv + GlobalConfig.EquipPointConstConfig.rankGrowUp];
        this.curAtt.text = AttributeData.getAttStr(config.attrs, 1);
        if (nextConfig)
            this.nextAtt.text = AttributeData.getAttStr(nextConfig.attrs, 1);
        var role1 = SubRoles.ins().getSubRoleByIndex(roleIndex);
        var zhuzaiData1 = role1.getZhuZaiDataByIndex(this.selectIndex);
        var rank = zhuzaiData1.rank;
        var rankConfig = GlobalConfig.EquipPointRankConfig[index][rank];
        this.currentState = rankConfig ? "normal" : "max";
        if (rankConfig) {
            var itemID = rankConfig.rankUpItem.id;
    ...
    ZhuzaiEquipAdvancePanel.prototype.setEquipPoint = function () {
    ...
    ZhuzaiEquipAdvancePanel.prototype.setSelect = function (v) {
    ...
    ZhuzaiEquipAdvancePanel.prototype.onClick = function (e) {
        ...
        var role = SubRoles.ins().getSubRoleByIndex(this.roleSelectPanel.getCurRole());
        var zhuzaiData = role.getZhuZaiDataByIndex(this.selectIndex);
        var lv = zhuzaiData.rank;
        var config = GlobalConfig.EquipPointRankConfig[this.selectIndex + 1][lv];
    ...
    return ZhuzaiEquipAdvancePanel;
}(BaseComponent));
__reflect(ZhuzaiEquipAdvancePanel.prototype, "ZhuzaiEquipAdvancePanel");
//# sourceMappingURL=ZhuzaiEquipAdvancePanel.js.map